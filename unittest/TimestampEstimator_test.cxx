...
BOOST_AUTO_TEST_CASE(Basics)
{
  ...
  BOOST_CHECK_EQUAL(te.wait_for_valid_timestamp(do_not_continue_flag), timinglibs::TimestampEstimatorBase::kInterrupted);
  ...
  BOOST_CHECK_EQUAL(te.wait_for_timestamp(ts_now+clock_frequency_hz, continue_flag), timinglibs::TimestampEstimatorBase::kFinished);

  ts_now=te.get_timestamp_estimate();
  BOOST_CHECK_EQUAL(te.wait_for_timestamp(ts_now+clock_frequency_hz, do_not_continue_flag), timinglibs::TimestampEstimatorBase::kInterrupted);
