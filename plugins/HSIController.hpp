...
public:
  ...
  HSIController(const HSIController&) =
    delete; ///< HSIController is not copy-constructible
  HSIController& operator=(const HSIController&) =
    delete; ///< HSIController is not copy-assignable
  HSIController(HSIController&&) =
    delete; ///< HSIController is not move-constructible
  HSIController& operator=(HSIController&&) =
    delete; ///< HSIController is not move-assignable
...
private:
  ...
  // Configuration
  hsicontroller::ConfParams m_cfg;
